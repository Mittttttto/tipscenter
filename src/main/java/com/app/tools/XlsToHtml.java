...
public class XlsToHtml {
    ...
    public static void main(String[] args) {
        ...
        String path = "E://Microsoft Excel 工作表.xlsx";//E://Microsoft Excel 工作表.xlsx
        InputStream is = null;
        ...
        try {
            ...
            if (wb instanceof XSSFWorkbook) {
                ...
                htmlExcel = XlsToHtml.getExcelInfo(xWb,true);
            }else if(wb instanceof HSSFWorkbook){
                HSSFWorkbook hWb = (HSSFWorkbook) wb;
                htmlExcel = XlsToHtml.getExcelInfo(hWb,true);
            }
    ...
    public String readExcelToHtml(String filePath , boolean isWithStyle){
        ...
        try {
            ...
            if (wb instanceof XSSFWorkbook) {
                XSSFWorkbook xWb = (XSSFWorkbook) wb;
                htmlExcel = XlsToHtml.getExcelInfo(xWb,isWithStyle);
            }else if(wb instanceof HSSFWorkbook){
                HSSFWorkbook hWb = (HSSFWorkbook) wb;
                htmlExcel = XlsToHtml.getExcelInfo(hWb,isWithStyle);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }finally{
