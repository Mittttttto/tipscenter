 ...
 * Generated at: 2016-07-09 15:23:59 UTC
...
ii++;
      ...
      out.write("\t\t\t\t\t<p class=\"pr-p1\">");
 out.print(sdate.format(order.getTime()));
      out.write("</p>\t\r\n");
      out.write("\t\t\t\t\t<p class=\"pr-p2\">");
out.print("订单号:"+order.getId());
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t<p class=\"pr-p2\">");
if(order.getState()==3){ out.print(contactList.get(ii).getAddress()+"    "+contactList.get(ii).getRecivername()+"("+contactList.get(ii).getMobile()+")");}
      out.write("</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\r\n");
...
out.print(item.getCity());
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<p class=\"pr-con-sl f-l\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t ");
...
cid= (Long)session.getAttribute("cid");  
      ...
      out.write("                \t<a href=\"/orderlist?action=myOrder&currentPage=");
...
out.print(i); 
      ...
      out.write("\r\n");
      out.write("                    \t<li><a href=\"/orderlist?action=myOrder&currentPage=");
out.print(i); 
      out.write('"');
      out.write('>');
out.print(i); 
